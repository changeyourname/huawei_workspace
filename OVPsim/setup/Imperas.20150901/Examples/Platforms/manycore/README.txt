...
FILE:Imperas/Examples/Platforms/manycore/README.txt
...
This example shows how many processors can be instanced.
...
3. Makefiles to build 1 and 2 in the sub-directories

BUILDING THE SIMULATION --------------------------------------------
To build the application (CROSS=OR1K as this is the processor type 
...
> platform/platform.<IMPERAS_ARCH>.exe --program application/fibonacci.<CROSS>.elf
