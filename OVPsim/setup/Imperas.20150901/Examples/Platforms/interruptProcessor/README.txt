...
FILE:Imperas/Examples/Platforms/processorInterrupt/README.txt
...
This example shows how an asynchronous event can be generated on a
processors external net while running an application in the CpuManager
environment.
This example can only be used in the Linux environment as it installs
a Linux Control-C handler.
...
While the example is running use the keyboard to enter control-C. This 
will cause the simulation to be interrupted and the current instruction
count for the interrupted processor displayed.
