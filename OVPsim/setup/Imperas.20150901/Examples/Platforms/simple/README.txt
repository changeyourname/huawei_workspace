...
FILE:Imperas/Examples/Platforms/simple/README.txt
...
This example shows the use of the ICM API functions to create a platform that
allows an application simulation to be invoked.
