...
FILE:Imperas/Examples/Platforms/hexLoader/README.txt
...
icm memory access functions to create custom file (or data) loaders.
...
Swapping the bytes can be done in the platform.c file by enabling swapping 
