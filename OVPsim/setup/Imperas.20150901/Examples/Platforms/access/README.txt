...
FILE:Imperas/Examples/Platforms/access/README.txt
...
This example shows that as well as tracing the execution of a program using 
ICM attributes, the ICM API gives full access to the state of the processor
model giving complete flexibility for the trace output.
