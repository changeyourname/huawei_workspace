...
FILE:Imperas/Examples/Platforms/debugSystemC_TLM2.0WithGDB/README.txt
...
Linux
> make -f ${IMPERAS_HOME}/ImperasLib/buildutils/Makefile.TLM.platform.${IMPERAS_UNAME} \
    PLATFORM=platform
	
Windows	
> nmake -nologo -s -f %IMPERAS_HOME%/ImperasLib/buildutils/Makefile.TLM.platform.%IMPERAS_UNAME% ^
    PLATFORM=platform
...
> platform/platform.<OS>.exe application/application/application.<CROSS>.elf
