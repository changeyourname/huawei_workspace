...
FILE:Imperas/Examples/Platforms/relaxedsched/README.txt
...
This example shows an option to increase the performance of simulations
in the CpuManager environment.
