...
FILE:Imperas/Examples/Platforms/tracing/README.txt
...
This example shows the use of the ICM attributes ICM_ATTR_TRACE and 
ICM_ATTR_TRACE_REGS that can be passed to the simulator to allow tracing of 
the application by providing an instruction-by-instruction disassembly and 
register display.
