...
void platformConstructor(void) {
    ...
    icmInitAttrs alwaysNonSecure_attrs = ICM_INIT_DEFAULT;

    icmInitPlatform(ICM_VERSION, alwaysNonSecure_attrs, 0, 0, "alwaysNonSecure");
...
////////////////////////////////////////////////////////////////////////////////
    ...
    icmNewBusBridge(handles.tzBus_b, handles.pBus_b, "uart0NS", "sp", "mp", 0x10000000, 0x10000fff, 0x10010000000ULL);
}
