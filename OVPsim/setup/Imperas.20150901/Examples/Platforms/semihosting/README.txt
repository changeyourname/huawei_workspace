...
FILE:Imperas/Examples/Platforms/semihosting/README.txt
...
This example shows the use of semihosting in the Imperas modeling environment.
The example independently from the model uses a semihosting library to support 
the system level calls to allow printing to stdout.
