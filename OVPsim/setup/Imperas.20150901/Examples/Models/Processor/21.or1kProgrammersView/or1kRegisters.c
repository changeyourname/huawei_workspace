...
//
#define OR1K_CB_REG_RW(_RCB, _WCB, _G) \
    access   : vmi_RA_RW,           \
    readCB   : _RCB,                \
    writeCB  : _WCB,                \
    group    : _G
...
static const vmiRegInfo registers[] = {
    ...
    OR1K_REG_INFO("R9",     9,  vmi_REG_NONE, OR1K_BITS, OR1K_RAW_REG_RW(regs[9],         OR1K_GROUP(GPR))   , 0),
    ...
    OR1K_REG_INFO("PC",    64,  vmi_REG_PC,   OR1K_BITS, OR1K_CB_REG_RW (readPC, writePC, OR1K_GROUP(SYSTEM)), 0),
    OR1K_REG_INFO("SR",    65,  vmi_REG_NONE, OR1K_BITS, OR1K_CB_REG_R  (readSR,          OR1K_GROUP(SYSTEM)), "status register"),
    OR1K_REG_INFO("EPCR",  66,  vmi_REG_NONE, OR1K_BITS, OR1K_RAW_REG_R (EPC,             OR1K_GROUP(SYSTEM)), "Exception PC"),
    OR1K_REG_INFO("EEAR",  67,  vmi_REG_NONE, OR1K_BITS, OR1K_RAW_REG_R (EEAR,            OR1K_GROUP(SYSTEM)), "exception effective address "),

    // registers not visible in gdb
    OR1K_REG_INFO("EXCPT", 100, vmi_REG_NONE, OR1K_BITS, OR1K_RAW_REG_R (exception,       OR1K_GROUP(SYSTEM)), 0),
