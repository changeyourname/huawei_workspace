...
//
#define OR1K_EXCEPTION_INFO(_D) [OR1K_EXCPT_##_D] = {name:#_D, code:_D##_ADDRESS}

//
// Table of exception mode descriptors
//
static const vmiExceptionInfo exceptions[OR1K_EXCPT_LAST] = {
    OR1K_EXCEPTION_INFO(RST),
    OR1K_EXCEPTION_INFO(BUS),
    OR1K_EXCEPTION_INFO(DPF),
    OR1K_EXCEPTION_INFO(IPF),
    OR1K_EXCEPTION_INFO(TTI),
    OR1K_EXCEPTION_INFO(ILL),
    OR1K_EXCEPTION_INFO(EXI),
    OR1K_EXCEPTION_INFO(SYS),
};
