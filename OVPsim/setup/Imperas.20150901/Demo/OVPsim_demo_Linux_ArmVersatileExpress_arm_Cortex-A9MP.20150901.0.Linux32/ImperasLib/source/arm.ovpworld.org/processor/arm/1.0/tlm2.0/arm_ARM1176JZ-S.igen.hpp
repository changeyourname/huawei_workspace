...
#ifndef ARM_OVPWORLD_ORG_PROCESSOR_ARM_ARM1176JZ_S__1_0
#define ARM_OVPWORLD_ORG_PROCESSOR_ARM_ARM1176JZ_S__1_0

#include "ovpworld.org/modelSupport/tlmProcessor/1.0/tlm2.0/tlmProcessor.hpp"
using namespace sc_core;

class arm_ARM1176JZ_S : public icmCpu
{
  private:
    const char *getModel() {
  ...
  public:
    icmCpuMasterPort     ITCM0;
    icmCpuMasterPort     ITCM1;
    icmCpuMasterPort     DTCM0;
    icmCpuMasterPort     DTCM1;
    ...
    icmCpuInterrupt      CP15SDISABLE;
    icmCpuOutputNetPort  DMAIRQ;
    icmCpuOutputNetPort  DMASIRQ;
    icmCpuOutputNetPort  DMAEXTERRIRQ;
    icmCpuOutputNetPort  PMUIRQ;
    icmCpuOutputNetPort  VALRESET;
    icmCpuOutputNetPort  VALIRQ;
    icmCpuOutputNetPort  VALFIQ;
    icmCpuOutputNetPort  VALDEBUG;
    ...
    , CP15SDISABLE("CP15SDISABLE", this)
    , DMAIRQ("DMAIRQ", this)
    , DMASIRQ("DMASIRQ", this)
    , DMAEXTERRIRQ("DMAEXTERRIRQ", this)
    , PMUIRQ("PMUIRQ", this)
    , VALRESET("VALRESET", this)
    , VALIRQ("VALIRQ", this)
    , VALFIQ("VALFIQ", this)
    , VALDEBUG("VALDEBUG", this)
    , VICACK("VICACK", this)
