...
#define PREFIX "ArmVersatileExpress-CA15"
...
#define SMARTLOADER PREFIX"/smartLoader/"
#define UART0       PREFIX"/uart0/"
#define UART1       PREFIX"/uart1/"
#define CLCD        PREFIX"/clcd/"
//
...
int main(int argc, const char *argv[]) {
    ...
    icmCLPP parser = icmCLParser("ArmVersatileExpress-CA15", ICM_AC_ALL);
