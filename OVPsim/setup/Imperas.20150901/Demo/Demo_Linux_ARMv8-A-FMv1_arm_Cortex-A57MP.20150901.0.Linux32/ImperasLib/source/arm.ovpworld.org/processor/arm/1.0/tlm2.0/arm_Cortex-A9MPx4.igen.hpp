...
#ifndef ARM_OVPWORLD_ORG_PROCESSOR_ARM_CORTEX_A9MPX4__1_0
#define ARM_OVPWORLD_ORG_PROCESSOR_ARM_CORTEX_A9MPX4__1_0

#include "ovpworld.org/modelSupport/tlmProcessor/1.0/tlm2.0/tlmProcessor.hpp"
using namespace sc_core;

class arm_Cortex_A9MPx4 : public icmCpu
{
  private:
    const char *getModel() {
  ...
  public:
    ...
    icmCpuOutputNetPort  wdResetReq_CPU1;
    icmCpuInterrupt      wdReset_CPU1;
    icmCpuInterrupt      VINITHI_CPU1;
    icmCpuInterrupt      CFGEND_CPU1;
    icmCpuInterrupt      TEINIT_CPU1;
    icmCpuInterrupt      CFGNMFI_CPU1;
    ...
    icmCpuOutputNetPort  wdResetReq_CPU2;
    icmCpuInterrupt      wdReset_CPU2;
    icmCpuInterrupt      VINITHI_CPU2;
    icmCpuInterrupt      CFGEND_CPU2;
    icmCpuInterrupt      TEINIT_CPU2;
    icmCpuInterrupt      CFGNMFI_CPU2;
    ...
    icmCpuOutputNetPort  wdResetReq_CPU3;
    icmCpuInterrupt      wdReset_CPU3;
    icmCpuInterrupt      VINITHI_CPU3;
    icmCpuInterrupt      CFGEND_CPU3;
    icmCpuInterrupt      TEINIT_CPU3;
    icmCpuInterrupt      CFGNMFI_CPU3;
    icmCpuInterrupt      reset_CPU3;
    icmCpuInterrupt      fiq_CPU3;
    icmCpuInterrupt      irq_CPU3;
    icmCpuInterrupt      AXI_SLVERR_CPU3;
    icmCpuInterrupt      CP15SDISABLE_CPU3;
    ...
    , wdResetReq_CPU1("wdResetReq_CPU1", this)
    , wdReset_CPU1("wdReset_CPU1", this)
    , VINITHI_CPU1("VINITHI_CPU1", this)
    , CFGEND_CPU1("CFGEND_CPU1", this)
    , TEINIT_CPU1("TEINIT_CPU1", this)
    , CFGNMFI_CPU1("CFGNMFI_CPU1", this)
    ...
    , wdResetReq_CPU2("wdResetReq_CPU2", this)
    , wdReset_CPU2("wdReset_CPU2", this)
    , VINITHI_CPU2("VINITHI_CPU2", this)
    , CFGEND_CPU2("CFGEND_CPU2", this)
    , TEINIT_CPU2("TEINIT_CPU2", this)
    , CFGNMFI_CPU2("CFGNMFI_CPU2", this)
    ...
    , wdResetReq_CPU3("wdResetReq_CPU3", this)
    , wdReset_CPU3("wdReset_CPU3", this)
    , VINITHI_CPU3("VINITHI_CPU3", this)
    , CFGEND_CPU3("CFGEND_CPU3", this)
    , TEINIT_CPU3("TEINIT_CPU3", this)
    , CFGNMFI_CPU3("CFGNMFI_CPU3", this)
    , reset_CPU3("reset_CPU3", this)
    , fiq_CPU3("fiq_CPU3", this)
    , irq_CPU3("irq_CPU3", this)
    , AXI_SLVERR_CPU3("AXI_SLVERR_CPU3", this)
    , CP15SDISABLE_CPU3("CP15SDISABLE_CPU3", this)
    {
    }
