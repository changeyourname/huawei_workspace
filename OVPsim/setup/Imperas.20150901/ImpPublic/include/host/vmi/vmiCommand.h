...
#ifndef VMICOMMAND_H_
#define VMICOMMAND_H_
...
typedef enum vmiArgTypeE {
    VMI_CA_NONE = 0,
    VMI_CA_ADDRESS,         // address
    VMI_CA_ENUMERATION,     // enum
    VMI_CA_FLAG,            // bool
    VMI_CA_FLOAT,           // C float
    VMI_CA_INTEGER,         // signed 32-bit integer
...
//
typedef Uns32 vmiArgAttrs;

#define VMI_CAA_DEFAULT        0x0000 // Not used in a menu
#define VMI_CAA_MENU           0x0001 // Appears in a menu
#define VMI_CAA_ENABLE         0x0010 // This argument enables the command
#define VMI_CAA_VALUE_CALLBACK 0x0020 // Ptr points to a function to get the value
...
// This array is also passed to the -get callback if the
...
#define VMI_CT_MODE           0x00000003   // Command that changes simulator behaviour
...
#define VMI_CT_HELP           0x00100000   // Let the parser handle -help
