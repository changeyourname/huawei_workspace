...
#ifndef POWER_OVPWORLD_ORG_PROCESSOR_POWERPC32_400_M440__1_0
#define POWER_OVPWORLD_ORG_PROCESSOR_POWERPC32_400_M440__1_0

#include "ovpworld.org/modelSupport/tlmProcessor/1.0/tlm2.0/tlmProcessor.hpp"
using namespace sc_core;

class powerpc32_400_m440 : public icmCpu
{
  private:
    const char *getModel() {
        return icmGetVlnvString (NULL, "power.ovpworld.org", "processor", "powerpc32_400", "1.0", "model");
    }
  ...
  public:
    ...
    : icmCpu(name, ID, "powerpc32_400", getModel(), 0, semiHost ? ((0 == strlen(semiHost)) ? 0 : semiHost) : getSHL(), attrs, attrList, addressBits, dmi, cpuFlags)
