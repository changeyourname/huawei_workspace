...
#ifndef POWER_OVPWORLD_ORG_PROCESSOR_POWERPC32_MPC82X__1_0
#define POWER_OVPWORLD_ORG_PROCESSOR_POWERPC32_MPC82X__1_0

#include "ovpworld.org/modelSupport/tlmProcessor/1.0/tlm2.0/tlmProcessor.hpp"
using namespace sc_core;

class powerpc32_mpc82x : public icmCpu
{
  private:
    const char *getModel() {
