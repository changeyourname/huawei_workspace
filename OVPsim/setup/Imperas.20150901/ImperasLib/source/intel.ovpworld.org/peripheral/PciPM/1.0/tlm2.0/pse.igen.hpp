...
#ifndef INTEL_OVPWORLD_ORG_PERIPHERAL_PCIPM__1_0
#define INTEL_OVPWORLD_ORG_PERIPHERAL_PCIPM__1_0
#include "ovpworld.org/modelSupport/tlmPeripheral/1.0/tlm2.0/tlmPeripheral.hpp"
using namespace sc_core;

class PciPM : public icmPeripheral
{
  private:
    const char *getModel() {
        return icmGetVlnvString (NULL, "intel.ovpworld.org", "peripheral", "PciPM", "1.0", "pse");
    }
  ...
  public:
    ...
    PciPM(sc_module_name name, icmAttrListObject *initialAttrs = 0 )
