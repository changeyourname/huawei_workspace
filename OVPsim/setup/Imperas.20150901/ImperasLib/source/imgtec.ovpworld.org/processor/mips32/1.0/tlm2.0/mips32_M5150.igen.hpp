...
#ifndef IMGTEC_OVPWORLD_ORG_PROCESSOR_MIPS32_M5150__1_0
#define IMGTEC_OVPWORLD_ORG_PROCESSOR_MIPS32_M5150__1_0

#include "ovpworld.org/modelSupport/tlmProcessor/1.0/tlm2.0/tlmProcessor.hpp"
using namespace sc_core;

class mips32_M5150 : public icmCpu
{
  private:
    const char *getModel() {
  ...
  public:
    icmCpuMasterPort     ISPRAM;
    icmCpuMasterPort     DSPRAM;
    ...
    , ISPRAM (this, "ISPRAM", 32)
    , DSPRAM (this, "DSPRAM", 32)
    ...
    void dmi(bool on) {
        m_dmi = on;
        if(!on) {
            ISPRAM.invalidateDMI();
            DSPRAM.invalidateDMI();
