...
vmidDecodeTableP v850CreateDecodeTable_ISA_E0_32Bit(vmidDecodeTableP current) {
    ...
    //                         F09rs1   | rfu1| subop| rfu0| reg2|opcode| reg1|
    DECODE_ENTRY(22,      LDSR_F09RS1, "|00000|000001|00000|.....|111111|.....|");

    //                          F09sr   | rfu1| subop| rfu0| reg2|opcode| reg1|
    DECODE_ENTRY(22,       STSR_F09SR, "|00000|000010|00000|.....|111111|.....|");
...
vmidDecodeTableP v850CreateDecodeTable_ISA_E1_32Bit(vmidDecodeTableP current) {
    ...
    // ISA_E1 Drop through section to next table
    //
    DECODE_ENTRY(32,          INSTR48, "................00000110001.....");
    DECODE_ENTRY(32,          INSTR48, "...........010110000011110......");
    DECODE_ENTRY(32,          INSTR48, "...........100110000011110......");
    DECODE_ENTRY(32,          INSTR48, "...........110110000011110......");
...
vmidDecodeTableP v850CreateDecodeTable_ISA_E1_48Bit(vmidDecodeTableP current) {
    ...
    // ISA_E1 Drop through section to next table
    //
    DECODE_ENTRY(48,          INSTR64, "...........................................110110000011110......");
...
vmidDecodeTableP v850CreateDecodeTable_ISA_E2_32Bit(vmidDecodeTableP current) {
    ...
    // ISA_E2 Drop through section to next table
    //
    DECODE_ENTRY(32,          INSTR48, "...............000000010111.....");
    DECODE_ENTRY(32,          INSTR48, "...............000000110111.....");
