...
const static v850MorphAttr dispatchTable[V850_IT_LAST+1] = {
    ...
    // Format FISa Insns
    //
    [V850_IT_MADDF_S_FISA] = {arch:ISA_E2_FP, morph:morphMADDF_S_FISA},
    [V850_IT_MSUBF_S_FISA] = {arch:ISA_E2_FP, morph:morphMSUBF_S_FISA},
    [V850_IT_NMADDF_S_FISA] = {arch:ISA_E2_FP, morph:morphNMADDF_S_FISA},
    [V850_IT_NMSUBF_S_FISA] = {arch:ISA_E2_FP, morph:morphNMSUBF_S_FISA},
