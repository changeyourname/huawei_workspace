...
#define REGIC(_n)   *(Uns8*)  ((Uns32)&(INTCP0_reg1_data.IC000.value)+((_n)*sizeof(INTCP0_reg1_data.IC000)))
#define REGMR(_n)   *(Uns16*) ((Uns32)&(INTCP0_reg0_data.IMR0.value) +((_n)*sizeof(INTCP0_reg0_data.IMR0)))
