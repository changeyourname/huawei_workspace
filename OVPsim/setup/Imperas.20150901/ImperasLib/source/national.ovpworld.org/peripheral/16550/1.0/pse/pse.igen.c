...
static PPM_WRITE_CB(bport1_ab_mcr_maskWrite) {
    bport1_ab_data.mcr.value = (bport1_ab_data.mcr.value & 0xe0) | (data & 0x1f);
}
...
static void installNetPorts(void) {
    handles.reset_uart = ppmOpenNetPort("reset_uart");
    if (handles.reset_uart) {
        ppmInstallNetCallback(handles.reset_uart, resetCB, (void*)0);
    }

// To write to this net, use ppmWriteNet(handles.intOut, value);

    handles.intOut = ppmOpenNetPort("intOut");

}

PPM_NET_CB(reset_Reset) {
    if(value != 0 ) {
        bport1_ab_data.msr.value = 0xb0;
        bport1_ab_data.mcr.value = 0x0;
        bport1_ab_data.lcr.value = 0x0;
        bport1_ab_data.fcr.value = 0x0;
        bport1_ab_data.iir.value = 0x1;
        bport1_ab_data.ier_dlh.value = 0x0;
        bport1_ab_data.thr_dll.value = 0x0;
        bport1_ab_data.rbr_dll.value = 0x0;
    }
}
