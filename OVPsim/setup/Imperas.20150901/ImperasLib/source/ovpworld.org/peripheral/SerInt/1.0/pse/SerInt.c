...
// eg. if (diagnosticLevel > 0) bhmMessage("I", "SerInt", "Example");
...
int main(int argc, char *argv[]) {
    ...
    ppmDocNodeP Root1_node = ppmDocAddSection(0, "Root");
    {
        ...
        ppmDocAddText(doc_22_node, "This is a register description only. The model does not contain any functionality");
