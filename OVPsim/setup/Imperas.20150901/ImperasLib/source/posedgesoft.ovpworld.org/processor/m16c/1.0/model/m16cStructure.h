...
#define M16C_REG_R0LB   16+2  // Changed order of registers to allow for compound registers R2R0 and R3R1
#define M16C_REG_R0HB   16+3
#define M16C_REG_R0B    16+2
#define M16C_REG_R1LB   16+6
#define M16C_REG_R1HB   16+7
#define M16C_REG_R1B    16+6
#define M16C_REG_R2B    16+0
#define M16C_REG_R2R0B  16+0
#define M16C_REG_R3B    16+4
#define M16C_REG_R3R1B  16+4
#define M16C_REG_A0B    16+8
#define M16C_REG_A1B    16+10
#define M16C_REG_A1A0B  16+8
#define M16C_REG_FBB    16+12
