...
//
// Read callback for 16-bit register returned in 32-bit buffer
//
static VMI_REG_READ_FN(readReg16to32) {

    m16cP  m16c  = (m16cP)processor;
    Uns32  index = (UnsPS)reg->userData;
    Uns16 *src   = (Uns16*)(&m16c->regs[index]);
...
//
// Write callback for 16-bit register passed in 32-bit buffer
//
static VMI_REG_WRITE_FN(writeReg16to32) {

    m16cP  m16c  = (m16cP)processor;
    Uns32  index = (UnsPS)reg->userData;
    Uns16 *dst   = (Uns16*)(&m16c->regs[index]);
...
static const vmiRegInfo frameRegs[] = {
    ...
    M16_REG_INFO_CB("R0",    0x00, vmi_REG_NONE, 32, vmi_RA_RW, readReg16to32, writeReg16to32, (void*)M16C_REG_R0),
    M16_REG_INFO_CB("R1",    0x02, vmi_REG_NONE, 32, vmi_RA_RW, readReg16to32, writeReg16to32, (void*)M16C_REG_R1),
    M16_REG_INFO_CB("R2",    0x04, vmi_REG_NONE, 32, vmi_RA_RW, readReg16to32, writeReg16to32, (void*)M16C_REG_R2),
    M16_REG_INFO_CB("R3",    0x06, vmi_REG_NONE, 32, vmi_RA_RW, readReg16to32, writeReg16to32, (void*)M16C_REG_R3),
    M16_REG_INFO_CB("A0",    0x08, vmi_REG_NONE, 32, vmi_RA_RW, readReg16to32, writeReg16to32, (void*)M16C_REG_A0),
    M16_REG_INFO_CB("A1",    0x0a, vmi_REG_NONE, 32, vmi_RA_RW, readReg16to32, writeReg16to32, (void*)M16C_REG_A1),
    M16_REG_INFO_CB("FB",    0x0c, vmi_REG_NONE, 32, vmi_RA_RW, readReg16to32, writeReg16to32, (void*)M16C_REG_FB),
