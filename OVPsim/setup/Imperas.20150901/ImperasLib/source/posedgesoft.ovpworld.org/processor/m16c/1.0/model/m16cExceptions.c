...
#define GET_REG16(_F) *(Uns16 *) & _F
#define GET_REG20(_F) *(Uns32 *) & _F
//
// Process Interrupt
//
...
static void doInterrupt(m16cP m16c) {
    ...
    Uns32 sp = (m16c->spSelectFlag == 0) ? GET_REG16(m16c->regs[M16C_REG_ISP]) : GET_REG16(m16c->regs[M16C_REG_USP]);
    ...
    Uns32 value = ((tempPC & 0x000F0000) << 4) |
                  (((Uns32) GET_REG16(m16c->regs[M16C_REG_FLG]) & 0x000070FF) << 16) |
                  (tempPC & 0x0000FFFF);
...
void m16cNewNetPorts(m16cP m16c) {
    ...
    m16cNetPort template[] = {
        { {"reset",  vmi_NP_INPUT,  (void*)0,     signalReset  }, 1 },
        { {"nmi",   vmi_NP_INPUT,  (void*)0,      signalNMI    }, 1 },

        { {"int_per",   vmi_NP_INPUT,  (void*)0,     signalMI     }, 1 },
        { {"int_ack", vmi_NP_OUTPUT, (void*)0, (void*)0, &m16c->intack }, 1 },
        { { 0 } }
    };
