...
VMI_DEBUG_FN(m16cDumpRegisters) {
    ...
    vmiPrintf(" R0: %04x    R0: %04x    INTB: %05x    I: %01x\n", *((Uns16 *)tmpP), *((Uns16 *)&m16c->regs[M16C_REG_R0B]), *((Uns32 *)&m16c->regs[M16C_REG_INTB]), m16c->intEnableFlag);
    vmiPrintf(" R1: %04x    R1: %04x    USP:   %04x    O: %01x\n", *((Uns16 *)&m16c->regs[M16C_REG_R1]), *((Uns16 *)&m16c->regs[M16C_REG_R1B]), *((Uns16 *)&m16c->regs[M16C_REG_USP]), m16c->overflowFlag);
    vmiPrintf(" R2: %04x    R2: %04x    ISP:   %04x    B: %01x\n", *((Uns16 *)&m16c->regs[M16C_REG_R2]), *((Uns16 *)&m16c->regs[M16C_REG_R2B]), *((Uns16 *)&m16c->regs[M16C_REG_ISP]), m16c->regBankSelectFlag);
    vmiPrintf(" R3: %04x    R3: %04x    SB:    %04x    S: %01x\n", *((Uns16 *)&m16c->regs[M16C_REG_R3]), *((Uns16 *)&m16c->regs[M16C_REG_R3B]), *((Uns16 *)&m16c->regs[M16C_REG_SB]), m16c->signFlag);
    vmiPrintf(" A0: %04x    A0: %04x    FLG:   %04x    Z: %01x\n", *((Uns16 *)&m16c->regs[M16C_REG_A0]), *((Uns16 *)&m16c->regs[M16C_REG_A0B]), *((Uns16 *)&m16c->regs[M16C_REG_FLG]), m16c->zeroFlag);
    vmiPrintf(" A1: %04x    A1: %04x           %04x    D: %01x\n", *((Uns16 *)&m16c->regs[M16C_REG_A1]), *((Uns16 *)&m16c->regs[M16C_REG_A1B]), *((Uns16 *)&m16c->regs[38]), m16c->debugFlag);
    vmiPrintf(" FB: %04x    FB: %04x    IPL:   %01x    C: %01x\n", *((Uns16 *)&m16c->regs[M16C_REG_FB]), *((Uns16 *)&m16c->regs[M16C_REG_FBB]), (*((Uns16 *)&m16c->regs[M16C_REG_FLG]) &0x7000) >> 12, m16c->carryFlag);
