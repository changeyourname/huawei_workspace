...
PPM_NET_CB(reset_resetNet) {
    if(value != 0 ) {
        bp1_REG_data.SF_PMR.value = 0x0;
        bp1_REG_data.SF_RSR.value = 0x0;
        bp1_REG_data.SF_EXID.value = 0x0;
        bp1_REG_data.SF_CIDR.value = 0x14000040;
    }
}
