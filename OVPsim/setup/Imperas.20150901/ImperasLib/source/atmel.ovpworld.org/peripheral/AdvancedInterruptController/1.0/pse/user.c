...
#define INFO if (BHM_DIAG_HIGH) {bhmMessage("I", "AIC", "val=0x%08x", data);}
#define TODO if (BHM_DIAG_HIGH) {bhmMessage("F", "AIC", "TODO");}
//
...
void write_nfiq(Uns32 value) {
    if (state.nfiq != value) {
        state.nfiq = value;
        if (BHM_DIAG_HIGH) bhmMessage("I", "AIC", "Setting Interrupt NFIQ=%d\n", state.nfiq);
...
void write_nirq(Uns32 value) {
    if (state.nirq != value) {
        state.nirq = value;
        if (BHM_DIAG_HIGH) bhmMessage("I", "AIC", "Setting Interrupt NIRQ=%d\n", state.nirq);
...
static void updateState() {
    if (BHM_DIAG_HIGH) bhmMessage("I", "AIC", "updateState state.pins=0x%08x", state.pins);
    ...
    //
    Bool rIRQ0   = !(((bp1_REG_data.AIC_SMR16.bits.SRCTYPE) >> 1) & 0x1) ^ ((state.pins >> IRQ0)   & 0x1);
    Bool rIRQ1   = !(((bp1_REG_data.AIC_SMR17.bits.SRCTYPE) >> 1) & 0x1) ^ ((state.pins >> IRQ1)   & 0x1);
    Bool rIRQ2   = !(((bp1_REG_data.AIC_SMR18.bits.SRCTYPE) >> 1) & 0x1) ^ ((state.pins >> IRQ2)   & 0x1);
    rIRQ0 = 0;
    rIRQ1 = 0;
    rIRQ2 = 0;
    ...
    //
    Uns32 pFIQ    = bp1_REG_data.AIC_SMR0.bits.PRIOR;
    Uns32 pSWIRQ  = bp1_REG_data.AIC_SMR1.bits.PRIOR;
    Uns32 pUS0IRQ = bp1_REG_data.AIC_SMR2.bits.PRIOR;
    Uns32 pUS1IRQ = bp1_REG_data.AIC_SMR3.bits.PRIOR;
    Uns32 pTC0IRQ = bp1_REG_data.AIC_SMR4.bits.PRIOR;
    Uns32 pTC1IRQ = bp1_REG_data.AIC_SMR5.bits.PRIOR;
    Uns32 pTC2IRQ = bp1_REG_data.AIC_SMR6.bits.PRIOR;
    Uns32 pWDIRQ  = bp1_REG_data.AIC_SMR7.bits.PRIOR;
    Uns32 pPIOIRQ = bp1_REG_data.AIC_SMR8.bits.PRIOR;
    Uns32 pIRQ0   = bp1_REG_data.AIC_SMR16.bits.PRIOR;
    Uns32 pIRQ1   = bp1_REG_data.AIC_SMR17.bits.PRIOR;
    Uns32 pIRQ2   = bp1_REG_data.AIC_SMR18.bits.PRIOR;
    
    //
    // Get source Vector register
    //
    Uns32 vFIQ    = bp1_REG_data.AIC_SVR0.value;
    Uns32 vSWIRQ  = bp1_REG_data.AIC_SVR1.value;
    Uns32 vUS0IRQ = bp1_REG_data.AIC_SVR2.value;
    Uns32 vUS1IRQ = bp1_REG_data.AIC_SVR3.value;
    Uns32 vTC0IRQ = bp1_REG_data.AIC_SVR4.value;
    Uns32 vTC1IRQ = bp1_REG_data.AIC_SVR5.value;
    Uns32 vTC2IRQ = bp1_REG_data.AIC_SVR6.value;
    Uns32 vWDIRQ  = bp1_REG_data.AIC_SVR7.value;
    Uns32 vPIOIRQ = bp1_REG_data.AIC_SVR8.value;
    Uns32 vIRQ0   = bp1_REG_data.AIC_SVR16.value;
    Uns32 vIRQ1   = bp1_REG_data.AIC_SVR17.value;
    Uns32 vIRQ2   = bp1_REG_data.AIC_SVR18.value;
    ...
    if (state.activeInt) {
        if (BHM_DIAG_HIGH) bhmMessage("I", "AIC", "updateState state.activeInt=%08x", state.activeInt);
...
#define MACRO_AIC_SMR_wcb(_index) \
    PPM_REG_WRITE_CB(AIC_SMR_wcb ## _index) { \
        bp1_REG_data.AIC_SMR ## _index .value = data; \
    }
    
#define MACRO_AIC_SVR_wcb(_index) \
    PPM_REG_WRITE_CB(AIC_SVR_wcb ## _index) { \
        bp1_REG_data.AIC_SVR ## _index .value = data; \
    }
...
MACRO_AIC_SMR_wcb(8)
MACRO_AIC_SMR_wcb(9)
MACRO_AIC_SMR_wcb(10)
MACRO_AIC_SMR_wcb(11)
MACRO_AIC_SMR_wcb(12)
MACRO_AIC_SMR_wcb(13)
MACRO_AIC_SMR_wcb(14)
MACRO_AIC_SMR_wcb(15)
MACRO_AIC_SMR_wcb(16)
MACRO_AIC_SMR_wcb(17)
MACRO_AIC_SMR_wcb(18)
MACRO_AIC_SMR_wcb(19)
MACRO_AIC_SMR_wcb(20)
MACRO_AIC_SMR_wcb(21)
MACRO_AIC_SMR_wcb(22)
MACRO_AIC_SMR_wcb(23)
MACRO_AIC_SMR_wcb(24)
MACRO_AIC_SMR_wcb(25)
MACRO_AIC_SMR_wcb(26)
MACRO_AIC_SMR_wcb(27)
MACRO_AIC_SMR_wcb(28)
MACRO_AIC_SMR_wcb(29)
MACRO_AIC_SMR_wcb(30)
MACRO_AIC_SMR_wcb(31)
...
MACRO_AIC_SVR_wcb(8)
MACRO_AIC_SVR_wcb(9)
MACRO_AIC_SVR_wcb(10)
MACRO_AIC_SVR_wcb(11)
MACRO_AIC_SVR_wcb(12)
MACRO_AIC_SVR_wcb(13)
MACRO_AIC_SVR_wcb(14)
MACRO_AIC_SVR_wcb(15)
MACRO_AIC_SVR_wcb(16)
MACRO_AIC_SVR_wcb(17)
MACRO_AIC_SVR_wcb(18)
MACRO_AIC_SVR_wcb(19)
MACRO_AIC_SVR_wcb(20)
MACRO_AIC_SVR_wcb(21)
MACRO_AIC_SVR_wcb(22)
MACRO_AIC_SVR_wcb(23)
MACRO_AIC_SVR_wcb(24)
MACRO_AIC_SVR_wcb(25)
MACRO_AIC_SVR_wcb(26)
MACRO_AIC_SVR_wcb(27)
MACRO_AIC_SVR_wcb(28)
MACRO_AIC_SVR_wcb(29)
MACRO_AIC_SVR_wcb(30)
MACRO_AIC_SVR_wcb(31)
