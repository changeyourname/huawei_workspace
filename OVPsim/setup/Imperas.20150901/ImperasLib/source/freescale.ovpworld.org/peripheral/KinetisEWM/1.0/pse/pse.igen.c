...
static PPM_WRITE_CB(bport1_ab_CMPH_maskWrite) {
    bport1_ab_data.CMPH.value = (bport1_ab_data.CMPH.value & 0x0) | (data & 0xff);
}

static PPM_WRITE_CB(bport1_ab_CMPL_maskWrite) {
    bport1_ab_data.CMPL.value = (bport1_ab_data.CMPL.value & 0x0) | (data & 0xff);
}

static PPM_WRITE_CB(bport1_ab_CTRL_maskWrite) {
    bport1_ab_data.CTRL.value = (bport1_ab_data.CTRL.value & 0xf0) | (data & 0xf);
}

static PPM_WRITE_CB(bport1_ab_SERV_maskWrite) {
    bport1_ab_data.SERV.value = (bport1_ab_data.SERV.value & 0x0) | (data & 0xff);
}
...
PPM_NET_CB(reset_Reset) {
    if(value != 0 ) {
        bport1_ab_data.CMPH.value = 0xff;
        bport1_ab_data.CMPL.value = 0x0;
        bport1_ab_data.SERV.value = 0x0;
