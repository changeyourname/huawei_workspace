...
static void resetTCD(void)
{
    ...
    // Setup pointers to the dmaInterrupt, so we don't have to go through large case statement.
    tcdReg[0].dmaInterrupt  = handles.dmaInterrupt_ch0;
    tcdReg[16].dmaInterrupt = handles.dmaInterrupt_ch0;
    tcdReg[1].dmaInterrupt  = handles.dmaInterrupt_ch1;
    tcdReg[17].dmaInterrupt = handles.dmaInterrupt_ch1;
    tcdReg[2].dmaInterrupt  = handles.dmaInterrupt_ch2;
    tcdReg[18].dmaInterrupt = handles.dmaInterrupt_ch2;
    tcdReg[3].dmaInterrupt  = handles.dmaInterrupt_ch3;
    tcdReg[19].dmaInterrupt = handles.dmaInterrupt_ch3;
    tcdReg[4].dmaInterrupt  = handles.dmaInterrupt_ch4;
    tcdReg[20].dmaInterrupt = handles.dmaInterrupt_ch4;
    tcdReg[5].dmaInterrupt  = handles.dmaInterrupt_ch5;
    tcdReg[21].dmaInterrupt = handles.dmaInterrupt_ch5;
    tcdReg[6].dmaInterrupt  = handles.dmaInterrupt_ch6;
    tcdReg[22].dmaInterrupt = handles.dmaInterrupt_ch6;
    tcdReg[7].dmaInterrupt  = handles.dmaInterrupt_ch7;
    tcdReg[23].dmaInterrupt = handles.dmaInterrupt_ch7;
    tcdReg[8].dmaInterrupt  = handles.dmaInterrupt_ch8;
    tcdReg[24].dmaInterrupt = handles.dmaInterrupt_ch8;
    tcdReg[9].dmaInterrupt  = handles.dmaInterrupt_ch9;
    tcdReg[25].dmaInterrupt = handles.dmaInterrupt_ch9;
    tcdReg[10].dmaInterrupt = handles.dmaInterrupt_ch10;
    tcdReg[26].dmaInterrupt = handles.dmaInterrupt_ch10;
    tcdReg[11].dmaInterrupt = handles.dmaInterrupt_ch11;
    tcdReg[27].dmaInterrupt = handles.dmaInterrupt_ch11;
    tcdReg[12].dmaInterrupt = handles.dmaInterrupt_ch12;
    tcdReg[28].dmaInterrupt = handles.dmaInterrupt_ch12;
    tcdReg[13].dmaInterrupt = handles.dmaInterrupt_ch13;
    tcdReg[29].dmaInterrupt = handles.dmaInterrupt_ch13;
    tcdReg[14].dmaInterrupt = handles.dmaInterrupt_ch14;
    tcdReg[30].dmaInterrupt = handles.dmaInterrupt_ch14;
    tcdReg[15].dmaInterrupt = handles.dmaInterrupt_ch15;
    tcdReg[31].dmaInterrupt = handles.dmaInterrupt_ch15;
}
////////////////////////////////////////////////////////////////////////////////
...
PPM_REG_READ_CB(regRead32) {
    Uns32 offset = (Uns32) addr - (Uns32) handles.bport1;
...
void userInit(void)
{
    ...
    chState.thread = bhmCreateThread(
                ...
                (void*) 0,
                threadName,
                &chState.stack[THREAD_STACK] // top of downward growing stack
            );
