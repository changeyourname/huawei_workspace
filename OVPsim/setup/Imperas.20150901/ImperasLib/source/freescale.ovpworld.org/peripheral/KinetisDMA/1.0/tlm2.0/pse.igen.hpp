...
#ifndef FREESCALE_OVPWORLD_ORG_PERIPHERAL_KINETISDMA__1_0
#define FREESCALE_OVPWORLD_ORG_PERIPHERAL_KINETISDMA__1_0
#include "ovpworld.org/modelSupport/tlmPeripheral/1.0/tlm2.0/tlmPeripheral.hpp"
using namespace sc_core;

class KinetisDMA : public icmPeripheral
{
  private:
    const char *getModel() {
        return icmGetVlnvString (NULL, "freescale.ovpworld.org", "peripheral", "KinetisDMA", "1.0", "pse");
    }
  ...
  public:
    ...
    KinetisDMA(sc_module_name name, icmAttrListObject *initialAttrs = 0 )
