...
#ifndef FREESCALE_OVPWORLD_ORG_PERIPHERAL_UART__1_0
#define FREESCALE_OVPWORLD_ORG_PERIPHERAL_UART__1_0
...
class Uart : public icmPeripheral
{
  private:
    const char *getModel() {
        return icmGetVlnvString (NULL, "freescale.ovpworld.org", "peripheral", "Uart", "1.0", "pse");
    }
