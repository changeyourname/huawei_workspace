...
static PPM_WRITE_CB(bport1_ab_B1T_maskWrite) {
    bport1_ab_data.B1T.value = (bport1_ab_data.B1T.value & 0x0) | (data & 0xff);
}
...
static PPM_WRITE_CB(bport1_ab_C6_maskWrite) {
    bport1_ab_data.C6.value = (bport1_ab_data.C6.value & 0xf) | (data & 0xf0);
}
...
static PPM_WRITE_CB(bport1_ab_CPW_maskWrite) {
    bport1_ab_data.CPW.value = (bport1_ab_data.CPW.value & 0x0) | (data & 0xff);
}
...
static PPM_WRITE_CB(bport1_ab_IE_maskWrite) {
    bport1_ab_data.IE.value = (bport1_ab_data.IE.value & 0x80) | (data & 0x7f);
}
...
static PPM_WRITE_CB(bport1_ab_PCTH_maskWrite) {
    bport1_ab_data.PCTH.value = (bport1_ab_data.PCTH.value & 0x0) | (data & 0xff);
}

static PPM_WRITE_CB(bport1_ab_PCTL_maskWrite) {
    bport1_ab_data.PCTL.value = (bport1_ab_data.PCTL.value & 0x0) | (data & 0xff);
}
...
static PPM_WRITE_CB(bport1_ab_PRE_maskWrite) {
    bport1_ab_data.PRE.value = (bport1_ab_data.PRE.value & 0x0) | (data & 0xff);
}

static PPM_WRITE_CB(bport1_ab_RIDT_maskWrite) {
    bport1_ab_data.RIDT.value = (bport1_ab_data.RIDT.value & 0x0) | (data & 0xff);
}
...
static PPM_WRITE_CB(bport1_ab_S3_maskWrite) {
    bport1_ab_data.S3.value = (bport1_ab_data.S3.value & 0x20) | (data & 0xdf);
}

static PPM_WRITE_CB(bport1_ab_S4_maskWrite) {
    bport1_ab_data.S4.value = (bport1_ab_data.S4.value & 0xf0) | (data & 0xf);
}

static PPM_WRITE_CB(bport1_ab_SDTH_maskWrite) {
    bport1_ab_data.SDTH.value = (bport1_ab_data.SDTH.value & 0x0) | (data & 0xff);
}

static PPM_WRITE_CB(bport1_ab_SDTL_maskWrite) {
    bport1_ab_data.SDTL.value = (bport1_ab_data.SDTL.value & 0x0) | (data & 0xff);
}
...
static PPM_WRITE_CB(bport1_ab_TIDT_maskWrite) {
    bport1_ab_data.TIDT.value = (bport1_ab_data.TIDT.value & 0x0) | (data & 0xff);
}
...
static PPM_WRITE_CB(bport1_ab_TPL_maskWrite) {
    bport1_ab_data.TPL.value = (bport1_ab_data.TPL.value & 0x0) | (data & 0xff);
}

static PPM_WRITE_CB(bport1_ab_WB_maskWrite) {
    bport1_ab_data.WB.value = (bport1_ab_data.WB.value & 0x0) | (data & 0xff);
}
...
PPM_NET_CB(reset_Reset) {
    if(value != 0 ) {
        bport1_ab_data.TIDT.value = 0x0;
        bport1_ab_data.RIDT.value = 0x0;
        bport1_ab_data.CPW.value = 0x0;
        bport1_ab_data.RPREL.value = 0x0;
        bport1_ab_data.RPL.value = 0x0;
        bport1_ab_data.S4.value = 0x0;
        bport1_ab_data.S3.value = 0x0;
        bport1_ab_data.WB.value = 0x0;
        bport1_ab_data.IE.value = 0x0;
        bport1_ab_data.TPL.value = 0x0;
        bport1_ab_data.PRE.value = 0x0;
        bport1_ab_data.SDTL.value = 0x0;
        bport1_ab_data.SDTH.value = 0x0;
        bport1_ab_data.B1T.value = 0x0;
        bport1_ab_data.PCTL.value = 0x0;
        bport1_ab_data.PCTH.value = 0x0;
