...
static PPM_WRITE_CB(bport1_ab_CTAR2_maskWrite) {
    bport1_ab_data.CTAR2.value = (bport1_ab_data.CTAR2.value & 0x0) | (data & 0xffffffff);
}

static PPM_WRITE_CB(bport1_ab_CTAR3_maskWrite) {
    bport1_ab_data.CTAR3.value = (bport1_ab_data.CTAR3.value & 0x0) | (data & 0xffffffff);
}

static PPM_WRITE_CB(bport1_ab_MCR_maskWrite) {
    bport1_ab_data.MCR.value = (bport1_ab_data.MCR.value & 0x30c080f8) | (data & 0xcf3f7f07);
}

static PPM_WRITE_CB(bport1_ab_PUSHR_maskWrite) {
    bport1_ab_data.PUSHR.value = (bport1_ab_data.PUSHR.value & 0xc00000) | (data & 0xff3fffff);
}

static PPM_WRITE_CB(bport1_ab_RSER_maskWrite) {
    bport1_ab_data.RSER.value = (bport1_ab_data.RSER.value & 0x60d4ffff) | (data & 0x9f2b0000);
}

static PPM_WRITE_CB(bport1_ab_SR_maskWrite) {
    bport1_ab_data.SR.value = (bport1_ab_data.SR.value & 0x25d7ffff) | (data & 0xda280000);
}
...
static void installRegisters(void) {
    ...
    ppmCreateRegister("ab_CTAR2",
        "DSPI Clock and Transfer Attributes Register (In Master Mode), array offset: 0xC, array step: 0x4",
        handles.bport1,
        20,
        4,
        read_32,
        bport1_ab_CTAR2_maskWrite,
        view32,
        &(bport1_ab_data.CTAR2.value),
        True
    );
    ppmCreateRegister("ab_CTAR3",
        "DSPI Clock and Transfer Attributes Register (In Master Mode), array offset: 0xC, array step: 0x4",
        handles.bport1,
        24,
        4,
        read_32,
        bport1_ab_CTAR3_maskWrite,
        view32,
        &(bport1_ab_data.CTAR3.value),
        True
    );
...
PPM_NET_CB(reset_Reset) {
    if(value != 0 ) {
        ...
        bport1_ab_data.SR.value = 0x2010000;
        bport1_ab_data.CTAR3.value = 0x78000000;
        bport1_ab_data.CTAR2.value = 0x78000000;
        bport1_ab_data.CTAR1.value = 0x78000000;
        bport1_ab_data.CTAR0.value = 0x78000000;
        bport1_ab_data.TCR.value = 0x0;
        bport1_ab_data.MCR.value = 0x1;
    }
}
