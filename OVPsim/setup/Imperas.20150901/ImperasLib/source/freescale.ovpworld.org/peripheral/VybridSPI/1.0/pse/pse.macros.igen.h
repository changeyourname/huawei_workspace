...
#define BPORT1_AB_CTAR2    (BPORT1 + 0x14)

#define BPORT1_AB_CTAR2_ASC   (0xf << 8)
#define BPORT1_AB_CTAR2_BR   0xf
#define BPORT1_AB_CTAR2_CPHA   (0x1 << 25)
#define BPORT1_AB_CTAR2_CPOL   (0x1 << 26)
#define BPORT1_AB_CTAR2_CSSCK   (0xf << 12)
#define BPORT1_AB_CTAR2_DBR   (0x1 << 31)
#define BPORT1_AB_CTAR2_DT   (0xf << 4)
#define BPORT1_AB_CTAR2_FMSZ   (0xf << 27)
#define BPORT1_AB_CTAR2_LSBFE   (0x1 << 24)
#define BPORT1_AB_CTAR2_PASC   (0x3 << 20)
#define BPORT1_AB_CTAR2_PBR   (0x3 << 16)
#define BPORT1_AB_CTAR2_PCSSCK   (0x3 << 22)
#define BPORT1_AB_CTAR2_PDT   (0x3 << 18)
#define BPORT1_AB_CTAR3    (BPORT1 + 0x18)

#define BPORT1_AB_CTAR3_ASC   (0xf << 8)
#define BPORT1_AB_CTAR3_BR   0xf
#define BPORT1_AB_CTAR3_CPHA   (0x1 << 25)
#define BPORT1_AB_CTAR3_CPOL   (0x1 << 26)
#define BPORT1_AB_CTAR3_CSSCK   (0xf << 12)
#define BPORT1_AB_CTAR3_DBR   (0x1 << 31)
#define BPORT1_AB_CTAR3_DT   (0xf << 4)
#define BPORT1_AB_CTAR3_FMSZ   (0xf << 27)
#define BPORT1_AB_CTAR3_LSBFE   (0x1 << 24)
#define BPORT1_AB_CTAR3_PASC   (0x3 << 20)
#define BPORT1_AB_CTAR3_PBR   (0x3 << 16)
#define BPORT1_AB_CTAR3_PCSSCK   (0x3 << 22)
#define BPORT1_AB_CTAR3_PDT   (0x3 << 18)
