...
#endif
#define BPORT1_AB_TCSR    (BPORT1 + 0x0)
...
#define BPORT1_AB_TCR1    (BPORT1 + 0x4)

#define BPORT1_AB_TCR1_TFW   0x7
#define BPORT1_AB_TCR2    (BPORT1 + 0x8)
...
#define BPORT1_AB_TCR3    (BPORT1 + 0xc)

#define BPORT1_AB_TCR3_TCE   (0x3 << 16)
#define BPORT1_AB_TCR3_WDFL   0x1f
#define BPORT1_AB_TCR4    (BPORT1 + 0x10)
...
#define BPORT1_AB_RCR1    (BPORT1 + 0x84)

#define BPORT1_AB_RCR1_RFW   0x7
#define BPORT1_AB_RCR2    (BPORT1 + 0x88)
...
#define BPORT1_AB_RCR3    (BPORT1 + 0x8c)

#define BPORT1_AB_RCR3_RCE   (0x3 << 16)
#define BPORT1_AB_RCR3_WDFL   0x1f
#define BPORT1_AB_RCR4    (BPORT1 + 0x90)
