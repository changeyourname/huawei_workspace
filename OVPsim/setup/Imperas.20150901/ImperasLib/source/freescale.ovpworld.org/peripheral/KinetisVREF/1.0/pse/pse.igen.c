...
static PPM_WRITE_CB(bport1_ab_SC_maskWrite) {
    bport1_ab_data.SC.value = (bport1_ab_data.SC.value & 0x3c) | (data & 0xc3);
}

static PPM_WRITE_CB(bport1_ab_TRM_maskWrite) {
    bport1_ab_data.TRM.value = (bport1_ab_data.TRM.value & 0xc0) | (data & 0x3f);
}
