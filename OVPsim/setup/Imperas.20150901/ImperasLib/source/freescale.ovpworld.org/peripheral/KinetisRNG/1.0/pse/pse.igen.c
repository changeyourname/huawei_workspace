...
static PPM_WRITE_CB(bport1_ab_CR_maskWrite) {
    bport1_ab_data.CR.value = (bport1_ab_data.CR.value & 0xffffffe0) | (data & 0x1f);
}

static PPM_WRITE_CB(bport1_ab_ER_maskWrite) {
    bport1_ab_data.ER.value = (bport1_ab_data.ER.value & 0x0) | (data & 0xffffffff);
}
...
PPM_NET_CB(reset_Reset) {
    if(value != 0 ) {
        bport1_ab_data.OR.value = 0x0;
        bport1_ab_data.ER.value = 0x0;
        bport1_ab_data.SR.value = 0x10000;
