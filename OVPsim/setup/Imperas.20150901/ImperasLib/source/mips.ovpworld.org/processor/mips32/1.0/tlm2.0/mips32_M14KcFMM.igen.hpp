...
#ifndef MIPS_OVPWORLD_ORG_PROCESSOR_MIPS32_M14KCFMM__1_0
#define MIPS_OVPWORLD_ORG_PROCESSOR_MIPS32_M14KCFMM__1_0

#include "ovpworld.org/modelSupport/tlmProcessor/1.0/tlm2.0/tlmProcessor.hpp"
using namespace sc_core;

class mips32_M14KcFMM : public icmCpu
{
  private:
    const char *getModel() {
