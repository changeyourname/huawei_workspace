...
#ifndef MIPS_OVPWORLD_ORG_PROCESSOR_MIPS32_MICROAPTIVP__1_0
#define MIPS_OVPWORLD_ORG_PROCESSOR_MIPS32_MICROAPTIVP__1_0

#include "ovpworld.org/modelSupport/tlmProcessor/1.0/tlm2.0/tlmProcessor.hpp"
using namespace sc_core;

class mips32_microAptivP : public icmCpu
{
  private:
    const char *getModel() {
