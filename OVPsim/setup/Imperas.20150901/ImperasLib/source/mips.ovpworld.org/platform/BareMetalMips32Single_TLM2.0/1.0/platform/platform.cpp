...
class BareMetalMips32Single_TLM2_0 : public sc_core::sc_module {
  ...
  public:
    ...
    const char *semihostForovp_cpu1() {
        return icmGetVlnvString (NULL, "mips.ovpworld.org", "semihosting", "mips32SDE", 0, "model");
    }
    const char *semihostFormips_cpu1() {
            return icmGetVlnvString (NULL, "mips.com", "semihosting", "mips32SDE", 0, "model");
    }
...
BareMetalMips32Single_TLM2_0::~BareMetalMips32Single_TLM2_0 () {
