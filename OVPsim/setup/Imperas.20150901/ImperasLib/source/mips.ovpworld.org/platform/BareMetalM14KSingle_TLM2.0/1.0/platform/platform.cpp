...
class BareMetalM14KSingle_TLM2_0 : public sc_core::sc_module {
  ...
  public:
    BareMetalM14KSingle_TLM2_0 (sc_core::sc_module_name name, bool *defaultVendor, const char *variant);
...
BareMetalM14KSingle_TLM2_0::BareMetalM14KSingle_TLM2_0 ( sc_core::sc_module_name name, bool *defaultVendor, const char *variant)
...
BareMetalM14KSingle_TLM2_0::~BareMetalM14KSingle_TLM2_0 () {
...
int sc_main (int argc, char *argv[] )
{
    ...
    // instantiate example top module
    BareMetalM14KSingle_TLM2_0 top("top", &defaultVendor, variant);
