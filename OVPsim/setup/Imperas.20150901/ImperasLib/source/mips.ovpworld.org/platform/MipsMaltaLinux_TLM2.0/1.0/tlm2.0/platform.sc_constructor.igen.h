...
#include "mips.ovpworld.org/processor/mips32/1.0/tlm2.0/mips32_24KEf.igen.hpp"
...
class MipsMaltaLinux_TLM2_0 : public sc_core::sc_module {
  ...
  public:
    MipsMaltaLinux_TLM2_0 (sc_core::sc_module_name name);
    ...
    icmAttrListObject *attrsFormipsle1() {
        ...
        userAttrs->addAttr("vectoredinterrupt", "disable");
        userAttrs->addAttr("config1MMUSizeM1", (int)63);
        userAttrs->addAttr("endian", "little");
        return userAttrs;
    }

    icmAttrListObject *attrsForCore_Board_SDRAM_promInit() {
        icmAttrListObject *userAttrs = new icmAttrListObject;
        userAttrs->addAttr("kernel", "vmlinux");
        userAttrs->addAttr("boardid", (int)0x00000420);
    ...
    icmAttrListObject *attrsForPIIX4() {
        icmAttrListObject *userAttrs = new icmAttrListObject;
        userAttrs->addAttr("PCIslot", (int)10);
        return userAttrs;
    }
    ...
    icmAttrListObject *attrsForPIIX4_IDE() {
        icmAttrListObject *userAttrs = new icmAttrListObject;
        userAttrs->addAttr("PCIslot", (int)10);
        userAttrs->addAttr("PCIfunction", (int)1);
    ...
    icmAttrListObject *attrsForPCI_USB() {
        icmAttrListObject *userAttrs = new icmAttrListObject;
        userAttrs->addAttr("PCIslot", (int)10);
        userAttrs->addAttr("PCIfunction", (int)2);
        return userAttrs;
    }
    ...
    icmAttrListObject *attrsForPCI_PM() {
        icmAttrListObject *userAttrs = new icmAttrListObject;
        userAttrs->addAttr("PCIslot", (int)10);
        userAttrs->addAttr("PCIfunction", (int)3);
        return userAttrs;
    }

    icmAttrListObject *attrsForPCI_NET() {
        icmAttrListObject *userAttrs = new icmAttrListObject;
        userAttrs->addAttr("PCIslot", (int)11);
        userAttrs->addAttr("PCIfunction", (int)0);
        userAttrs->addAttr("pollDelay", (int)1000);
        return userAttrs;
    }
    ...
    icmAttrListObject *attrsForPs2() {
        icmAttrListObject *userAttrs = new icmAttrListObject;
        userAttrs->addAttr("pollPeriod", (int)50000);
    ...
    icmAttrListObject *attrsForuartTTY0() {
        icmAttrListObject *userAttrs = new icmAttrListObject;
        userAttrs->addAttr("outfile", "uartTTY0.log");
        userAttrs->addAttr("console", "enable");
        userAttrs->addAttr("finishOnDisconnect", "y");
        return userAttrs;
    }
    ...
    icmAttrListObject *attrsFormaltaFpga() {
        icmAttrListObject *userAttrs = new icmAttrListObject;
        userAttrs->addAttr("stoponsoftreset", (int)1);
        return userAttrs;
    }
...
MipsMaltaLinux_TLM2_0::MipsMaltaLinux_TLM2_0 ( sc_core::sc_module_name name)
    ...
    , flashBus("flashBus")
    , Core_Board_SDRAM ("Core_Board_SDRAM", "sp1", 0x7ffffff)
    , Monitor_Flash ("Monitor_Flash", "sp1", 0x3fffff)
    , mipsle1 ( "mipsle1", 0, ICM_ATTR_SIMEX, attrsFormipsle1() )
    , Core_Board_SDRAM_promInit ("Core_Board_SDRAM_promInit", attrsForCore_Board_SDRAM_promInit())
    ...
    , pit ("pit")
    , rtc ("rtc", attrsForrtc())
    , uartTTY0 ("uartTTY0", attrsForuartTTY0())
    ...
    , sysControl ("sysControl")
{
    ...
    bus1.setDecode(21, 0x1e000000, 0x1e0fffff);
    ...
    flashBus.setDecode(0, 0x1e000000, 0x1e3fffff);
