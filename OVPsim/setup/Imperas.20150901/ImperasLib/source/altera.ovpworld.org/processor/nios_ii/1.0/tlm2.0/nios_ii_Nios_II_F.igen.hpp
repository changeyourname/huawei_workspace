...
#ifndef ALTERA_OVPWORLD_ORG_PROCESSOR_NIOS_II_NIOS_II_F__1_0
#define ALTERA_OVPWORLD_ORG_PROCESSOR_NIOS_II_NIOS_II_F__1_0

#include "ovpworld.org/modelSupport/tlmProcessor/1.0/tlm2.0/tlmProcessor.hpp"
using namespace sc_core;

class nios_ii_Nios_II_F : public icmCpu
{
  private:
    const char *getModel() {
