...
static void installRegisters(void) {
    ...
    ppmCreateRegister("REGS_mpumodrst",
        0,
        handles.bport1,
        16,
        4,
    ...
    ppmCreateRegister("REGS_permodrst",
        0,
        handles.bport1,
        20,
        4,
    ...
    ppmCreateRegister("REGS_per2modrst",
        0,
        handles.bport1,
        24,
        4,
    ...
    ppmCreateRegister("REGS_brgmodrst",
        0,
        handles.bport1,
        28,
        4,
    ...
    ppmCreateRegister("REGS_miscmodrst",
        0,
        handles.bport1,
        32,
        4,
...
// To write to this net, use ppmWriteNet(handles.cpu0Reset, value);

    handles.cpu0Reset = ppmOpenNetPort("cpu0Reset");

// To write to this net, use ppmWriteNet(handles.cpu1Reset, value);

    handles.cpu1Reset = ppmOpenNetPort("cpu1Reset");

}

PPM_NET_CB(reset_resetNet) {
    if(value != 0 ) {
        bport1_REGS_data.miscmodrst.value = 0x0;
        bport1_REGS_data.brgmodrst.value = 0x7;
        bport1_REGS_data.per2modrst.value = 0xff;
        bport1_REGS_data.permodrst.value = 0x3fffffff;
        bport1_REGS_data.mpumodrst.value = 0x2;
        bport1_REGS_data.counts.value = 0x80080;
        bport1_REGS_data.ctrl.value = 0x100000;
        bport1_REGS_data.stat.value = 0x0;
    }
}
