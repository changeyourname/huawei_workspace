...
PPM_NET_CB(reset_IRESET) {
    if(value != 0 ) {
        sp1_reg0_data.t5ev.value = 0x0;
        sp1_reg0_data.t5hi.value = 0x0;
        sp1_reg0_data.t5lo.value = 0x0;
        sp1_reg0_data.t4ev.value = 0x0;
        sp1_reg0_data.t4hi.value = 0x0;
        sp1_reg0_data.t4lo.value = 0x0;
        sp1_reg0_data.t3ev.value = 0x0;
        sp1_reg0_data.t3hi.value = 0x0;
        sp1_reg0_data.t3lo.value = 0x0;
        sp1_reg0_data.t2ev.value = 0x0;
        sp1_reg0_data.t2hi.value = 0x0;
        sp1_reg0_data.t2lo.value = 0x0;
        sp1_reg0_data.t1ev.value = 0x0;
        sp1_reg0_data.t1hi.value = 0x0;
        sp1_reg0_data.t1lo.value = 0x0;
        sp1_reg0_data.t0ev.value = 0x0;
        sp1_reg0_data.t0hi.value = 0x0;
        sp1_reg0_data.t0lo.value = 0x0;
    }
}
