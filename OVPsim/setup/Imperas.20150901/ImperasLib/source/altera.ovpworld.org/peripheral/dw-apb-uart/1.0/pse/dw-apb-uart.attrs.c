...
static ppmParameter parameters[] = {
    {
        .name        = "console",
        .type        = ppm_PT_BOOL,
        .description = "Standard Serial Socket Parameter: See OVP BHM and PPM API Function Reference:  Enables automatic console",
    },
    {
        .name        = "portnum",
        .type        = ppm_PT_UNS32,
    ...
    },
    {
        ...
        .type        = ppm_PT_BOOL,
        .description = "Standard Serial Socket Parameter: See OVP BHM and PPM API Function Reference:  When set the, simulation will be terminated if the port is disconnected",
    },
    {
        .name        = "simulatebaud",
        .type        = ppm_PT_BOOL,
