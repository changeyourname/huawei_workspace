...
#ifndef ALTERA_OVPWORLD_ORG_PERIPHERAL_INTERVALTIMER64CORE__1_0
#define ALTERA_OVPWORLD_ORG_PERIPHERAL_INTERVALTIMER64CORE__1_0
...
class IntervalTimer64Core : public icmPeripheral
{
  private:
    const char *getModel() {
        return icmGetVlnvString (NULL, "altera.ovpworld.org", "peripheral", "IntervalTimer64Core", "1.0", "pse");
    }
