...
PPM_CONSTRUCTOR_CB(constructor) {
    ...
    // Get the Attributes
    //
    Uns32 readBufferDepth   = 64;
    Uns32 readIRQThreshold  = 8;
    Uns32 writeBufferDepth  = 64;
    Uns32 writeIRQThreshold = 8;
    bhmIntegerAttribute("readBufferDepth",   &readBufferDepth);
    bhmIntegerAttribute("readIRQThreshold",  &readIRQThreshold);
    bhmIntegerAttribute("writeBufferDepth",  &writeBufferDepth);
    bhmIntegerAttribute("writeIRQThreshold", &writeIRQThreshold);
    ...
    bhmCreateThread(putChars, NULL, "putChars", &stackPUT[TOP]);
