...
#ifndef ARM_OVPWORLD_ORG_PROCESSOR_ARMM_CORTEX_M1__1_0
#define ARM_OVPWORLD_ORG_PROCESSOR_ARMM_CORTEX_M1__1_0

#include "ovpworld.org/modelSupport/tlmProcessor/1.0/tlm2.0/tlmProcessor.hpp"
using namespace sc_core;

class armm_Cortex_M1 : public icmCpu
{
  private:
    const char *getModel() {
  ...
  public:
    ...
    icmCpuMasterPort     ITCM;
    icmCpuMasterPort     DTCM;
