...
#ifndef ARM_OVPWORLD_ORG_PROCESSOR_ARMM_CORTEX_M0PLUS__1_0
#define ARM_OVPWORLD_ORG_PROCESSOR_ARMM_CORTEX_M0PLUS__1_0

#include "ovpworld.org/modelSupport/tlmProcessor/1.0/tlm2.0/tlmProcessor.hpp"
using namespace sc_core;

class armm_Cortex_M0plus : public icmCpu
{
  private:
    const char *getModel() {
