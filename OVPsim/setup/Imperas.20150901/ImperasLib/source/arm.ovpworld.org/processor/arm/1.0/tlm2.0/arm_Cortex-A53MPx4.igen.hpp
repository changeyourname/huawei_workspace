...
#ifndef ARM_OVPWORLD_ORG_PROCESSOR_ARM_CORTEX_A53MPX4__1_0
#define ARM_OVPWORLD_ORG_PROCESSOR_ARM_CORTEX_A53MPX4__1_0

#include "ovpworld.org/modelSupport/tlmProcessor/1.0/tlm2.0/tlmProcessor.hpp"
using namespace sc_core;

class arm_Cortex_A53MPx4 : public icmCpu
{
  private:
    const char *getModel() {
