...
#ifndef ARM_OVPWORLD_ORG_PROCESSOR_ARM_CORTEX_A15UP__1_0
#define ARM_OVPWORLD_ORG_PROCESSOR_ARM_CORTEX_A15UP__1_0

#include "ovpworld.org/modelSupport/tlmProcessor/1.0/tlm2.0/tlmProcessor.hpp"
using namespace sc_core;

class arm_Cortex_A15UP : public icmCpu
{
  private:
    const char *getModel() {
  ...
  public:
    ...
    icmCpuOutputNetPort  CNTVIRQ;
    icmCpuOutputNetPort  CNTPSIRQ;
    icmCpuOutputNetPort  CNTPNSIRQ;
    icmCpuOutputNetPort  CNTPHPIRQ;
    icmCpuInterrupt      VINITHI;
    icmCpuInterrupt      CFGEND;
    icmCpuInterrupt      CFGTE;
    icmCpuInterrupt      reset;
    icmCpuInterrupt      fiq;
    icmCpuInterrupt      irq;
    icmCpuInterrupt      vfiq;
    icmCpuInterrupt      virq;
    ...
    , DATA (this, "DATA", 32)
    , CNTVIRQ("CNTVIRQ", this)
    , CNTPSIRQ("CNTPSIRQ", this)
    , CNTPNSIRQ("CNTPNSIRQ", this)
    , CNTPHPIRQ("CNTPHPIRQ", this)
