...
#ifndef ARM_OVPWORLD_ORG_PERIPHERAL_COREMODULE9X6__1_0
#define ARM_OVPWORLD_ORG_PERIPHERAL_COREMODULE9X6__1_0
#include "ovpworld.org/modelSupport/tlmPeripheral/1.0/tlm2.0/tlmPeripheral.hpp"
using namespace sc_core;

class CoreModule9x6 : public icmPeripheral
{
  private:
    const char *getModel() {
  ...
  public:
    ...
    CoreModule9x6(sc_module_name name, icmAttrListObject *initialAttrs = 0 )
