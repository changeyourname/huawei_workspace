...
#ifndef ARM_OVPWORLD_ORG_PERIPHERAL_ICPCONTROL__1_0
#define ARM_OVPWORLD_ORG_PERIPHERAL_ICPCONTROL__1_0
...
class IcpControl : public icmPeripheral
{
  ...
  public:
    ...
    IcpControl(sc_module_name name, icmAttrListObject *initialAttrs = 0 )
        : icmPeripheral(name, getModel(), 0, initialAttrs)
        , bport1(this, "bport1", 0x10) // static
    {
    }
