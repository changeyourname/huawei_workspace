...
static void installRegisters(void) {
    ...
    ppmCreateRegister("ab_LED_ALPHA",
    ...
    ppmCreateRegister("ab_LED_LIGHTS",
    ...
    ppmCreateRegister("ab_LED_SWITCHES",
        "DIP Switch register",
        handles.bport1,
        8,
        4,
...
PPM_NET_CB(reset_reset) {
    if(value != 0 ) {
        bport1_ab_data.LED_SWITCHES.value = 0x0;
        bport1_ab_data.LED_LIGHTS.value = 0x0;
        bport1_ab_data.LED_ALPHA.value = 0x0;
    }
}
