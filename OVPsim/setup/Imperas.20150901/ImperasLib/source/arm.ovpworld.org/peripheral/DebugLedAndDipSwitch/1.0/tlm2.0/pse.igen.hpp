...
#ifndef ARM_OVPWORLD_ORG_PERIPHERAL_DEBUGLEDANDDIPSWITCH__1_0
#define ARM_OVPWORLD_ORG_PERIPHERAL_DEBUGLEDANDDIPSWITCH__1_0
...
class DebugLedAndDipSwitch : public icmPeripheral
{
  ...
  public:
    ...
    DebugLedAndDipSwitch(sc_module_name name, icmAttrListObject *initialAttrs = 0 )
