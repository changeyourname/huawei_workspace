...
static void installRegisters(void) {
    ...
    ppmCreateRegister("ab_NVFLAGSSET",
    ...
    ppmCreateRegister("ab_NVFLAGSCLR",
...
int main(int argc, char *argv[]) {
    ...
    ppmDocNodeP Root1_node = ppmDocAddSection(0, "Root");
    {
        ...
        ppmDocAddText(doc_22_node, "ARM Motherboard Express ìATX V2M-P1 Technical Reference Manual(ARM DUI 0447G), Section 4.3 Register Summary");
