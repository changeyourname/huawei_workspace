...
#define PLATFORM "BareMetalArmCortexADual"
...
void createPlatform() {
    ...
    icmAddStringAttr(icmAttr1, "endian",        "little");
    icmAddStringAttr(icmAttr1, "compatibility", "nopSVC");
    icmAddStringAttr(icmAttr1, "variant",       "Cortex-A9UP");	// Default variant
    icmAddStringAttr(icmAttr1, "UAL",           "1");
    ...
    icmAddStringAttr(icmAttr2, "endian",        "little");
    icmAddStringAttr(icmAttr2, "compatibility", "nopSVC");
    icmAddStringAttr(icmAttr2, "variant",       "Cortex-A9UP"); // Default variant
    icmAddStringAttr(icmAttr2, "UAL",           "1");
...
static void addPlatformDocumentation() {
    ...
    icmDocNodeP Root1_node = icmDocSectionAdd(0, "Root");
    {
        ...
        icmDocTextAdd(doc_12_node, "Bare Metal Platform for an ARM Cortex-A series Processor (default Cortex-A9UP).");
        icmDocTextAdd(doc_12_node, "The bare metal platform instantiates two ARM Cortex-A series processor instances.");
        ...
        icmDocTextAdd(doc_12_node, "The ICM platform can be passed any application compiled to an ARM elf format as the first argument. The "
