...
#include "arm.ovpworld.org/processor/armm/1.0/tlm2.0/armm_Cortex-M3.igen.hpp"
...
class BareMetalArmCortexMSingle_TLM2_0 : public sc_core::sc_module {
  ...
  public:
    BareMetalArmCortexMSingle_TLM2_0 (sc_core::sc_module_name name);
    ...
    icmAttrListObject *attrsForcpu1() {
        ...
        userAttrs->addAttr("variant", "Cortex-M3");
...
BareMetalArmCortexMSingle_TLM2_0::BareMetalArmCortexMSingle_TLM2_0 ( sc_core::sc_module_name name)
