...
#include "arm.ovpworld.org/processor/armm/1.0/tlm2.0/processor.igen.hpp"

////////////////////////////////////////////////////////////////////////////////
//                      BareMetalArmCortexMSingle_TLM2_0 Class                      //
////////////////////////////////////////////////////////////////////////////////

class BareMetalArmCortexMSingle_TLM2_0 : public sc_core::sc_module {

  public:
    BareMetalArmCortexMSingle_TLM2_0 (sc_core::sc_module_name name, const char *variant);
    ...
    icmAttrListObject *attrsForcpu(const char *variant) {
        ...
        userAttrs->addAttr("compatibility", "nopBKPT");
        userAttrs->addAttr("resetAtTime0",  "false");
        userAttrs->addAttr("variant",       variant);
        userAttrs->addAttr("UAL",           "1");
        return userAttrs;
    }
}; /* BareMetalArmCortexMSingle_TLM2_0 */

////////////////////////////////////////////////////////////////////////////////
//                   BareMetalArmCortexMSingle_TLM2_0 Constructor                   //
////////////////////////////////////////////////////////////////////////////////

BareMetalArmCortexMSingle_TLM2_0::BareMetalArmCortexMSingle_TLM2_0 ( sc_core::sc_module_name name, const char *variant)
...
int sc_main (int argc, char *argv[] )
{
    ...
    BareMetalArmCortexMSingle_TLM2_0 top("top", variant);             // instantiate example top module

    // Use the processor to load memory with the program.
    top.cpu1.loadLocalMemory(app, (icmLoaderAttrs)(ICM_SET_START|ICM_LOAD_VERBOSE ));
