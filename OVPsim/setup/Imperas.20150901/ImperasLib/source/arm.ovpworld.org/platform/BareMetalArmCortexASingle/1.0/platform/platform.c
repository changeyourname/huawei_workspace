...
#define PLATFORM "BareMetalArmCortexASingle"
...
void createPlatform() {
    ...
    icmAddStringAttr(icmAttr, "variant",       "Cortex-A9UP");
...
static void addPlatformDocumentation() {
	...
	icmDocNodeP Root1_node = icmDocSectionAdd(0, "Root");
	{
		...
		icmDocTextAdd(doc_12_node, "The bare metal platform instantiates a single ARM Cortex-A series processor instance.");
