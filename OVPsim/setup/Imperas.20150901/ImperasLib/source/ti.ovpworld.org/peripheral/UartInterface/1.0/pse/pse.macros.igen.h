...
#define BPORT1_AB_RSRECR    (BPORT1 + 0x4)
...
#define BPORT1_AB_FR    (BPORT1 + 0x18)
...
#define BPORT1_AB_FBRD    (BPORT1 + 0x24)

#define BPORT1_AB_FBRD_DIVFRAC   0x3f
#define BPORT1_AB_IBRD    (BPORT1 + 0x28)

#define BPORT1_AB_IBRD_DIVINT   0xffff
#define BPORT1_AB_LCRH    (BPORT1 + 0x2c)
...
#define BPORT1_AB_CTL    (BPORT1 + 0x30)
...
#define BPORT1_AB_RIS    (BPORT1 + 0x3c)
...
#define BPORT1_AB_PID0    (BPORT1 + 0xfd0)

#define BPORT1_AB_PID1    (BPORT1 + 0xfd4)

#define BPORT1_AB_PID2    (BPORT1 + 0xfd8)

#define BPORT1_AB_PID3    (BPORT1 + 0xfdc)

#define BPORT1_AB_PID4    (BPORT1 + 0xfe0)

#define BPORT1_AB_PID5    (BPORT1 + 0xfe4)

#define BPORT1_AB_PID6    (BPORT1 + 0xfe8)

#define BPORT1_AB_PID7    (BPORT1 + 0xfec)

#define BPORT1_AB_CID0    (BPORT1 + 0xff0)

#define BPORT1_AB_CID1    (BPORT1 + 0xff4)

#define BPORT1_AB_CID2    (BPORT1 + 0xff8)

#define BPORT1_AB_CID3    (BPORT1 + 0xffc)
