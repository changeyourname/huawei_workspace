...
ArmIntegratorCP::ArmIntegratorCP (
    ...
    , ambaDummy ("ambaDummy", "sp1", 0x0FFF)
    ...
    , lcdDummy("lcdDummy", "sp1", 0x1000000)
{
    ...
    bus1.setDecode(14, 0xC0000000, 0xC0FFFFFF);

    bus1.initiator_socket[15](ethlan.bport1.socket); // Ethernet Lan (Dummy)
    bus1.setDecode(15, 0xC8000000, 0xC8000FFF);
...
int sc_main (int argc, char *argv[] )
{
    ...
    ArmIntegratorCP top("top", bc, connect, port, variant);             // instantiate example top module
