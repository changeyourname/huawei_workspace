...
# Processor
#
ihwaddprocessor -instancename arm1 -type arm -vendor arm.ovpworld.org -endian little -simulateexceptions -mips 200.0
isetattribute -handle arm1 -name variant            -value ARM926EJ-S
isetattribute -handle arm1 -name compatibility      -value ISA
isetattribute -handle arm1 -name showHiddenRegs     -value 0
...
isetattribute    -handle       kb1 -name isMouse    -value 0
isetattribute    -handle       kb1 -name grabDisable -value 0
...
isetattribute    -handle       ms1 -name isMouse    -value 1
isetattribute    -handle       ms1 -name grabDisable -value 1
...
ihwaddperipheral -instancename uart1  -type UartPL011  -vendor arm.ovpworld.org -diagnosticlevel 1
isetattribute    -handle       uart1  -name variant  -value ARM
isetattribute    -handle       uart1  -name outfile  -value uart1.log
isetattribute    -handle       uart1  -name finishOnDisconnect -value 1
...
ihwaddperipheral -instancename uart2  -type UartPL011 -vendor arm.ovpworld.org -diagnosticlevel 1
isetattribute    -handle       uart2  -name variant  -value ARM
isetattribute    -handle       uart2  -name outfile  -value uart2.log
isetattribute    -handle       uart2  -name finishOnDisconnect -value 1
...
isetattribute    -handle       lcd  -name busOffset -value 0x80000000
isetattribute    -handle       lcd  -name scanDelay -value 50000
