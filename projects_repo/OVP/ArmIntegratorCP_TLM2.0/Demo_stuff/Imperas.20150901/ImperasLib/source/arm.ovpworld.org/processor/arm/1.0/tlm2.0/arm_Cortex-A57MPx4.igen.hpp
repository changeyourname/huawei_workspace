...
#ifndef ARM_OVPWORLD_ORG_PROCESSOR_ARM_CORTEX_A57MPX4__1_0
#define ARM_OVPWORLD_ORG_PROCESSOR_ARM_CORTEX_A57MPX4__1_0

#include "ovpworld.org/modelSupport/tlmProcessor/1.0/tlm2.0/tlmProcessor.hpp"
using namespace sc_core;

class arm_Cortex_A57MPx4 : public icmCpu
{
  private:
    const char *getModel() {
  ...
  public:
    ...
    icmCpuOutputNetPort  CNTVIRQ_CPU3;
    icmCpuOutputNetPort  CNTPSIRQ_CPU3;
    icmCpuOutputNetPort  CNTPNSIRQ_CPU3;
    icmCpuOutputNetPort  CNTPHPIRQ_CPU3;
    icmCpuOutputNetPort  IRQOUT_CPU3;
    icmCpuOutputNetPort  FIQOUT_CPU3;
    icmCpuInterrupt      VINITHI_CPU3;
    icmCpuInterrupt      CFGEND_CPU3;
    icmCpuInterrupt      CFGTE_CPU3;
    icmCpuInterrupt      reset_CPU3;
    icmCpuInterrupt      fiq_CPU3;
    icmCpuInterrupt      irq_CPU3;
    icmCpuInterrupt      vfiq_CPU3;
    icmCpuInterrupt      virq_CPU3;
    ...
    , CNTVIRQ_CPU3("CNTVIRQ_CPU3", this)
    , CNTPSIRQ_CPU3("CNTPSIRQ_CPU3", this)
    , CNTPNSIRQ_CPU3("CNTPNSIRQ_CPU3", this)
    , CNTPHPIRQ_CPU3("CNTPHPIRQ_CPU3", this)
    , IRQOUT_CPU3("IRQOUT_CPU3", this)
    , FIQOUT_CPU3("FIQOUT_CPU3", this)
    , VINITHI_CPU3("VINITHI_CPU3", this)
    , CFGEND_CPU3("CFGEND_CPU3", this)
    , CFGTE_CPU3("CFGTE_CPU3", this)
    , reset_CPU3("reset_CPU3", this)
    , fiq_CPU3("fiq_CPU3", this)
    , irq_CPU3("irq_CPU3", this)
    , vfiq_CPU3("vfiq_CPU3", this)
    , virq_CPU3("virq_CPU3", this)
