...
#if DBG
      printf("a) Int_1_Loc: %x\n", Int_1_Loc); fflush(stdout);
      printf("a) Int_2_Loc: %x\n", Int_2_Loc); fflush(stdout);
      printf("a) Int_3_Loc: %x\n\n", Int_3_Loc); fflush(stdout);
#endif
...
//  printf ("  Ptr_Comp:          %d\n", (int) Next_Ptr_Glob->Ptr_Comp);
 ...
 /* microseconds */
  ...
  printf("Begin Time = %d\n",Begin_Time); fflush(stdout);
  printf("End Time   = %d\n",End_Time); fflush(stdout);
  ...
  else
  {
    ...
    User_Time /= DLX_FREQ;
#if DLX
    printf("DLX%c", ' '); fflush(stdout);
#else
#if OR1K
    printf("OR1K%c", ' '); fflush(stdout);
#else
    printf("Unknown CPU%c", '\n'); fflush(stdout);
#endif
#endif
    printf("at %u MHz  ", DLX_FREQ); fflush(stdout);
    if (PROC_6)
	    printf("(+PROC_6) "); fflush(stdout);
    printf(" %c", '\n'); fflush(stdout);
#endif
...
#if DBG
      printf("X) Int_1_Par_Val: %x\n", Int_1_Par_Val); fflush(stdout);
      printf("X) Int_2_Par_Val: %x\n", Int_2_Par_Val); fflush(stdout);
#endif
