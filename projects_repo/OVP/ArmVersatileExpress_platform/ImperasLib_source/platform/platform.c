...
#define PREFIX "ArmVersatileExpress-CA9"
...
#define SMARTLOADER "ArmVersatileExpress-CA9/smartLoader/"
#define UART0       "ArmVersatileExpress-CA9/uart0/"
#define UART1       "ArmVersatileExpress-CA9/uart1/"
#define LCD1        "ArmVersatileExpress-CA9/lcd1/"
#define CLCD        "ArmVersatileExpress-CA9/clcd/"
//
...
int main(int argc, const char *argv[]) {
    ...
    icmCLPP parser = icmCLParser("ArmVersatileExpress-CA9", ICM_AC_ALL);
    ...
    if (options.boot) {
        // Load the boot file
        icmLoadBus(handles.pBus_b, options.boot, ICM_LOAD_VERBOSE, True);
    }
